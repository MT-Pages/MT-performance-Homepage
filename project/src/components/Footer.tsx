    ...
    <footer className="bg-[#0f1819] text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-300 mb-4">
              Performance und Persönlichkeitsentwicklung für Ihr volles
              Potenzial.
            </p>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300">
              ...
              <p className="mt-2">
                <a
                  href="mailto:info@mt-performance.ch"
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>
            © {currentYear} Michael Trüssel Performance. Alle Rechte
            vorbehalten.
          </p>
        </div>
      </div>
...
function SocialLink({ href, icon }: { href: string; icon: string }) {
  // Hilfsfunktion für robusten SVG-Path-Check
  function isValidPath(path: any) {
    return typeof path === "string" && /[mM]/.test(path);
  }

  // Platzhalter-Icon (Kreis mit Ausrufezeichen)
  ...
  if (icon === "facebook") {
    ...
    // Falscher Icon-Name
    console.warn(`Unbekanntes Social-Icon: ${icon}`);
