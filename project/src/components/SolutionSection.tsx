        ...
        <div className="mt-12 relative">
          ...
          <div className="relative">
            {steps.map((step, index) => (
              ...
              >
                <div className={`flex items-center ${step.position === 'left' ? 'flex-row-reverse' : 'flex-row'}`}>
                  {/* Content Side */}
                  <div className={`w-1/2 ${step.position === 'left' ? 'pr-8 text-right' : 'pl-8'}`}>
                    <h3 className="text-xl font-bold text-white mb-2">{step.title}</h3>
                  </div>
                  
                  {/* Icon Circle */}
                  <div className="relative">
                    <div className="w-12 h-12 bg-[#d4af37] rounded-full flex items-center justify-center text-white z-10 relative">
                      {step.icon}
                    </div>
                    {/* Arrow */}
                    <div 
                      className={`absolute top-1/2 -translate-y-1/2 w-8 h-0.5 bg-[#d4af37] ${
                        step.position === 'left' ? 'right-full' : 'left-full'
                      }`}
                    />
                  </div>
