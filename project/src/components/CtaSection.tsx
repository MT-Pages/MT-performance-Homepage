  ...
  return (
    <section className="py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl bg-white rounded-[2.5rem] p-8 text-center shadow-lg mx-auto">
          ...
          <p className="text-[#0f1819] mb-4">
            Klicke auf den Button, beantworte ein paar kurze Fragen – und
            Michael Trüssel meldet sich persönlich bei dir.
          </p>
